...
//    private AudioRecordCore mAudioRecord;
//    private int mAudioTrackIndex;
//    private List<byte[]> mPCMContainer;
...
//                    mBufferInfo.presentationTimeUs = TIMEOUT_USEC;
...
//                MediaFormat newAudioFormat = mAudioEncoder.getOutputFormat();
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    encodedData.position(mBufferInfo.offset);
                    encodedData.limit(mBufferInfo.offset + mBufferInfo.size);
                    Log.e("time_span", "drainEncoder_" + mBufferInfo.presentationTimeUs);
